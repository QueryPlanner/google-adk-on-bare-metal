...
def mock_dependencies():
    ...
    with patch("google.adk.cli.fast_api.get_fast_api_app") as mock_get_app, \
        ...
        # Helper to support .host and .port access if needed, though mostly attributes are accessed
...
def test_server_session_db_kwargs_configuration(mock_dependencies):
    """Verify session_db_kwargs is correctly configured and passed to get_fast_api_app."""
